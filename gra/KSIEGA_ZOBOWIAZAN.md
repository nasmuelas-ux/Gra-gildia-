...
| ### ⚠ **RADA ZIMOWA — jedyna pozycja bez rekomendacji** | ### **Osiem to reguły. Ta jedna to stały organ z prawem pytania o cudze zboże** — a pierwszy skorzysta **Roose Bolton, i skorzysta legalnie.** ### Wersja bezpieczna: **organ CZYTAJĄCY, nie pytający** — schodzi się w Dzień Bilansu, czyta liczby, których i tak nie wolno ukryć, nie ma własnych ludzi | **300-04-01** | 300-02-28 |
| ### **KARHOLD DOSTAJE ZNOWU NIC** | Akademia → Przystań Wilka, przystań cofnięta. Otwarte u Rickarda: zniewaga 298-10 — cena krwi Warryka — ośmioletni zakaz marchii — **zeznanie przy świadkach 300-04-01** — **12 smoków zaległej daniny, ten sam termin**. ### **Zostaje mu z całej wiązki narzędzie ⑥ — podatek w ziarnie.** *Wschód nie ma srebra. Wschód ma zboże* | **300-04-01** | 300-02-28 |
