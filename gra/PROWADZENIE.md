...
**1b. ZBIEŻNOŚĆ TEŻ JEST TWIERDZENIEM I TEŻ WYMAGA ŹRÓDŁA.** Dwa wątki łączą się wtedy, gdy łączy je **zapis** — ta sama osoba, to samo miejsce, ten sam rozkaz, ta sama data. **Nie wtedy, gdy łączy je moje wrażenie, że pasują do siebie.**
> *Dopisane 300-02-25, tego samego dnia co 1a. Po tym, jak scalanie dubli okazało się słuszne siedem razy, zacząłem widzieć dubel wszędzie, gdzie dwie rzeczy miały wspólne słowo. Połączyłem zwiad kamienia pod Gorący Port (ujście Fever, kilka dni od Fosy) ze zwiadem pod Starkport (Cypel Morskiego Smoka, tygodnie stąd) — bo oba są „na zachodzie". I ogłosiłem, że księga miar Nesty leży nietknięta, choć była wdrożona. **Przy Wylisie wymyśliłem fakt; tu wymyśliłem ZWIĄZEK między dwoma prawdziwymi faktami.** Drugie jest trudniejsze do złapania, bo każdy człon z osobna jest prawdą.*
