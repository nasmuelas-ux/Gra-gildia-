...
- [300-02-25] `ziemie_bez_pana_kamienisty_brzeg_299_09`: ### VOID (GM) - POLACZYLEM DWA ROZNE MIEJSCA. Poprawka gracza: 'Goracy Port jest rzeka Fever, zupelnie inny watek'. ### NAPISALEM godzine temu, ze zwiad kamienia pod baszte Goracego Portu i …
- [300-02-25] `miara_polnocna_standard_299_08`: ### WSKAZANIE GRACZA: 'KSIEGA WDROZONA'. Braavijska ksiega miar, wag i probierstwa od Nesty zostala przelozona na uzytek Polnocy - nie lezy nietknieta, jak napisalem godzine temu. Watek ksie…
- [300-02-25] `poprawki`: ### DWIE POPRAWKI GRACZA DO MOICH 'ZNALEZISK' - OBIE SLUSZNE I OBIE TEGO SAMEGO RODZAJU. (1) Goracy Port lezy u ujscia rzeki FEVER - to zupelnie inny watek niz Kamienisty Brzeg i Cypel Morsk…
- [298-12-29] `zimowy_relief`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek zyl od 297 wylacznie w polach JSON i nie mial ANI JEDNEGO wpisu, wiec przy kazdym moim zapytaniu wracal pusty. Tresc przeniesiona w calosci, data …
- [298-11-28] `horyzont_daenerys_targaryen_1128`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek nie mial ani jednego wpisu; wracal pusty przy kazdym zapytaniu, a stoi w Ksiedze Zobowiazan jako sledzony z adnotacja 'ani jednej drogi'. ### TRES…
- [299-07-06] `oddzial_domu_tally_riverrun_299_07`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu. ### 299-07-06: EDMURE ZGODZIL SIE Z ENTUZJAZMEM. Filia komercyjna Domu Tally w Riverrun: handel, zboze, korytarz, kanal Ole…
- [299-09-15] `policz_talerze_rachunek_z_czarnego_zamku_299_09`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu, priorytet WYSOKI. ### POLICZ TALERZE - re-taskowanie placowki Domu Tally w Czarnym Zamku: rola przydzialow MIESIAC PO MIESI…
- [299-09-10] `rejestr_danin_polnocy_299_09`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu, priorytet WYSOKI. ### REJESTR DANIN POLNOCY - metoda powszechna; LICZBY USTALA RADA NA WNIOSEK SKARBNIKA; rola JAWNA z woli…
- [299-09-10] `sansa_uczy_dziedziny_dziesiatej_299_09`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu. ### SANSA UCZY DZIEDZINY X KANONU (mowa i sluchanie) - PROBNIE. ### ROZSTRZYGNIECIE METODYCZNE, ktore jest tu najwazniejsze…
- [299-09-10] `wezel_zachodni_domu_i_biala_plama_korony_299_09`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu. ### WEZEL DOMU NA ZACHODNIM WYBRZEZU = JEDYNE OCZY TAM, GDZIE KORONA ICH NIE MA. Symon zglasza sie jako STRONA Skarbnikowi …
- [299-09-10] `zastepcy_do_krukow_i_ksiag_299_09`: ### MIGRACJA DO DZIENNIKA 300-02-25 - watek bez ani jednego wpisu, priorytet WYSOKI. ### CZLOWIEK DO KRUKOW I KSIAG ZAMIAST MAESTERA - DWA-TRZY LATA ZAMIAST SZESNASTU (rachunek Luwina). ### …
- [300-02-25] `poprawki`: ### OSIEM NIEWIDZIALNYCH FILAROW PRZENIESIONYCH DO DZIENNIKA. Mialy cala tresc w starych polach JSON i ANI JEDNEGO wpisu - czyli przy kazdym moim `db.py pokaz` wracaly PUSTE. To nie byly wat…
