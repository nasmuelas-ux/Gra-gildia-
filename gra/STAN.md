...
## TERAZ
- **Data:** 299-09-19 popoludnie · lato (298)
...
- **Zdrowie 98 · Sytosc 38 · Zmeczenie 43**
...
## WATKI OTWARTE (592; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [299-09-19] `npc/rodrik_cassel`: 299-09-19 - DRUGA SESJA (rzut 89) I RZECZ, KTORA RODRIK ZROBIL Z WLASNEJ WOLI NA KONCU. Po treningu nie odeszl - kazal przyniesc pioro, bo, jak powiedzial, 'to, czego was ucze, jest bez wart…
- [299-09-19] `prawo_orszaku_co_sie_dzieje_gdy_zle_299_09`: 299-09-19 WATEK ZALOZONY - PRAWO ORSZAKU, podyktowane przez ser Rodrika Cassela po drugiej sesji treningu (rzut 89), spisane reka Symona i przeznaczone do odczytania NA GLOS calemu orszakowi…
- [299-09-19] `objazd_wschodu_jako_pierwszy_objazd_poborowy_299_09`: 299-09-19 popoludnie - LISTY ZAPOWIEDNE WYSLANE. Bez rzutu (wlasne pisma, odpowiedzi przyjda w swoim czasie). Spisane jako gra/listy_zapowiedne_objazd_299_09_19.md. || ZASADA: JEDNO PISMO, S…
- [299-09-19] `objazd_wschodu_jako_pierwszy_objazd_poborowy_299_09`: 299-09-19 - ZBIEG ZJAZDU I OBJAZDU, WYKRYTY DOPIERO PRZY WPISYWANIU DAT DO LISTOW, I OBROCONY W ZASADE. Zjazd choragwi stoi 299-10-05 w Winterfell, objazd rusza 09-22 - Symon mija sie z lord…
- [299-09-19] `hornwood_ziemia_bez_pana_299_09`: 299-09-19 WATEK ZALOZONY - HORNWOOD NIE MA DO KOGO ZAADRESOWAC PISMA. Przy adresowaniu szesciu listow zapowiednych wyszlo, ze pierwszy przystanek objazdu jest domem BEZ PANA: ziemia bez glow…
- [299-09-19] `npc/roose_bolton`: 299-09-19 - PISMO ZAPOWIEDNE DO DREADFORTU: IDENTYCZNE CO DO PRZECINKA. Bez rzutu. Symon rozwazyl i odrzucil kazde zdanie dodane. UZASADNIENIE ZAPISANE: 'Kazde slowo dopisane Roose'owi Bolto…
- [299-09-19] `rejestr_imion_lordow_polnocy_299_09`: 299-09-19 WATEK ZALOZONY - KORONA NIE ZNA IMION WLASNYCH LORDOW. Wyszlo przy adresowaniu kopert: przy LOCKE'u (Stary Zamek) i przy FLINCIE Z WDOWIEJ STRAZNICY w ksiegach Korony stoi dom i si…
- [299-09-19] `npc/nesta`: 299-09-19 - LIST PRYWATNY DO NESTY (Bialy Port, Kasa 1, zwykla poczta Domu, NIE przez kancelarie i NIE na papierze Korony). Bez rzutu. || DATY PODANE ZANIM STANA SIE POGLOSKA: Bialy Port ~11…
- [299-09-19] `hornwood_ziemia_bez_pana_299_09`: 299-09-19 - VOID PROWADZACEGO W CALOSCI (ROZSZERZENIE IV), NA SLUSZNY ZARZUT GRACZA. WATEK ZALOZONY BLEDNIE I NIE ISTNIEJE. Opisalem Hornwood jako 'ziemie bez pana, wakat, proznia' - czerpia…
- [299-09-19] `hornwood_proznia_dreadfort_299_08`: 299-09-19 - MELDUNEK ZALEGLY: CO SIE STALO Z OPERACJA HORNWOOD OD 299-08-04 (rzut wykonania 35 - polowicznie). Papiery Glovera lezaly w kancelarii; Symon wyciagnal je przy pisaniu listow zap…
- [299-09-19] `poselstwo_wolne_miasta_braavos_pentos_299_08`: 299-09-19 - LIST DO NESTY POPRAWIONY U PODSTAWY, ZANIM WYSZEDL (wskazanie gracza). PIERWSZA REDAKCJA BYLA PISANA DO CZLOWIEKA, KTORY ZOSTAJE W BIALYM PORCIE I PILNUJE KSIAG - a NESTA PLYNIE …
- [299-09-19] `poselstwo_wolne_miasta_braavos_pentos_299_08`: 299-09-19 - CO W POSELSTWIE NADAL NIEOBSADZONE, wypisane przy liscie do Nesty: (1) KTO JEDZIE Z RAMIENIA KORONY - poselstwo ma okret, ma glos (Nesta) i ma czlowieka Manderlych, ale sklad kor…
