...
## TERAZ
- **Data:** 299-10-01 zmierzch · lato (298)
...
- [299-10-03] `kanal_reed_przesmyk_1118`: ### ODPOWIEDZ SYMONA: CHRONOLOGIA, NIE PRZEKONANIE. Symon nie powiedzial 'wierze' ani 'boje sie'. PODAL DATY, bo o daty pytano: 299-05-12 - pierwszy szept ('prawdziwa zima NIE jest pora roku…
- [299-10-03] `kanal_reed_przesmyk_1118`: ### ODPOWIEDZ SYMONA NA WARUNEK REEDA - JEDNO ZDANIE: ### 'PRZESMYK TO NIE SCIANA, TYLKO BRAMA. A BRAMA MUSI SIE ZAMYKAC.' ### Bez rzutu (rzut 69 juz padl na te sprawe; to jest odpowiedz na …
- [299-10-03] `kanal_reed_przesmyk_1118`: ### TRZY PYTANIA SYMONA PRZY DOGASAJACYM OGNIU - RZUT 39 (nisko). Drzwi, ktore otworzyly sie przy chronologii, przymykaja sie przy tych trzech. NIC Z TEGO, CO JUZ DANE (przewodnicy, pomiar, …
- [299-10-03] `kanal_reed_przesmyk_1118`: ### VOID - BLAD PROWADZACEGO, WSKAZANY PRZEZ GRACZA I SLUSZNY. ROZSZERZENIE IV: BLAD GM NIE JEST KOSZTEM GRACZA. ### CO BYLO NIEPRAWDA: napisalem 'dwadziescia cztery godziny po tym, jak sie …
