...
- [300-02-25] `dlug_korony_wobec_domu_tally_299_10`: ### ROZSTRZYGNIECIE GRACZA: DLUG JEST WIEKSZY NIZ 310 SMOKOW, a upomnienie poszlo DO GAWENA, SKARBNIKA, z zadaniem ZWROTU W NATURZE. Watek prowadzi HAL - to sprawa Domu Handlowego, nie Koron…
- [300-02-25] `komory_wodne_dziura_w_poborze_299_09`: ### ROZSTRZYGNIECIE GRACZA: 'odeslalem garnizon + nowa formacje do pomocy, z tym w Fosie powinno spasc'. ### UCZCIWIE: NIE ZNALAZLEM W ZAPISIE MOMENTU, W KTORYM TEN ROZKAZ ZOSTAL WYDANY. To …
- [300-02-25] `woz_w_lodzie_przy_brodzie_299_09`: ### ROZSTRZYGNIECIE GRACZA: 'bedzie do odpytania'. Watek zostaje otwarty jako PYTANIE, nie jako sledztwo. ### KOGO ODPYTAC, PO KOLEI - bo woz stal dzien drogi od Fosy i ktos musial go widzie…
- [300-02-25] `sad_w_hornwood_299_11_15`: ### ROZSTRZYGNIECIE GRACZA: 'zapisac do rozstrzygniecia'. Zarzut Donelli wchodzi na liste rzeczy do rozstrzygniecia, NIE do zamkniecia milczeniem. ### ZARZUT W JEJ SLOWACH: 'FOSA CAILIN JEST…
- [300-02-25] `jak_obalic_polnoc_model_zagrozenia_299_12`: ### ROZSTRZYGNIECIE GRACZA: 'to jest pakiet reform, ktory bedzie szedl na rade'. Model zagrozenia przestaje byc ciekawa rozmowa z Pentos i staje sie PROJEKTEM NA WIELKA RADE 300-04-01. ### T…
- [300-02-25] `dlug_korony_wobec_domu_tally_299_10`: ### POPRAWKA GRACZA: 'jest to dokladnie opisane, Gawen pisal do mnie; skarbnik i Hal ma to ustalic'. Sprawdzone - ma racje, a ja pisalem godzine temu, ze 'brak liczby, towaru i terminu', jak…
- [300-02-25] `komory_wodne_dziura_w_poborze_299_09`: ### POPRAWKA GRACZA - DOKLADNIE KTO: 'HENDRY + FORMACJA STRAZY W CAILIN ZOSTALA POWOLANA DO POMOCY CELNIKOM'. Zapisalem godzine temu 'garnizon i nowa formacja odeslane' - nieprecyzyjnie i be…
- [300-02-25] `zestawienie_dni_barka_komora_299_09`: ### VOID (GM) - ZAMKNALEM DZIS WATEK, KTORY ZYJE. Odwrocone tego samego wieczoru. Przy przegladzie kubla D zobaczylem w nim slowo VOID i zamknalem calosc jako 'juz zvoidowane w zapisie'. ###…
- [300-02-25] `komory_wodne_dziura_w_poborze_299_09`: ### POPRAWKA GRACZA - FORMACJA MA NAZWE, A JEJ SZEF NIE: 'formacja zostaje nazwana, miano wybrac jej szefa'. ### NAZWA STOI OD 299-09-05, z projektu Cailin: ### MCHOWE JASTRZEBIE ### - straz…
- [300-02-25] `mchowe_jastrzebie_straz_lenna_300_02`: ### WSKAZANIE GRACZA: 'szef mial byc wybrany i mi podany'. SPRAWDZONE - MA RACJE CO DO SLOWA, a to jest zaniedbanie prowadzacego, nie zwloka jego ludzi. ### ROZKAZ Z 300-02-08, WYSLANY Z WIN…
- [300-02-25] `mchowe_jastrzebie_straz_lenna_300_02`: ### ODLOZONE NA ZADANIE GRACZA: 'zapisz do pokazania pozniej'. DWIE LISTY PO TRZY NAZWISKA LEZA GOTOWE I CZEKAJA NA ODCZYTANIE - nie wygasaja, nie gnija i nie wymagaja ponownego rozkazu. Gdy…
- [300-02-25] `poprawki`: ### KUBEL E PRZEJRZANY - 46 pozycji z ostatnich dwoch miesiecy. TO JEST ZYWA PLANSZA, wiec zamkniete tylko 4 zdarzenia (cztery kruki z 300-02-07, podroz Bialy Port-Winterfell, rachunek drogi…
