...
## WATKI OTWARTE (662; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-02-25] `deficyt_zywnosci_fosy_zima_299_06`: ### ZIARNO SIEWNE - ROZSTRZYGNIECIE GRACZA: 'nie wchodzi, oglaszamy poreczenie - damy siew na wiosne'. ### DO CHALUP SIE NIE WCHODZI. Cena polityczna wejscia nie zostaje zaplacona. ### DWA Z…
- [300-02-25] `spichlerz_polnocy_mistrz_zapasow_zimowych_300_02`: ### ZIARNO SIEWNE - ROZSTRZYGNIECIE GRACZA: 'nie wchodzi, oglaszamy poreczenie - damy siew na wiosne'. ### DO CHALUP SIE NIE WCHODZI. Cena polityczna wejscia nie zostaje zaplacona. ### DWA Z…
- [300-02-25] `soltysi_i_samorzad_lenna_299_08`: ### ZIARNO SIEWNE - ROZSTRZYGNIECIE GRACZA: 'nie wchodzi, oglaszamy poreczenie - damy siew na wiosne'. ### DO CHALUP SIE NIE WCHODZI. Cena polityczna wejscia nie zostaje zaplacona. ### DWA Z…
- [300-02-25] `soltysi_i_samorzad_lenna_299_08`: ### LENNO PLACI ZA ROBOTE - ROZSTRZYGNIECIE GRACZA, KONSEKWENCJA OCZYNSZOWANIA. Skoro nowy winien grosz a nie dni, robocizne trzeba KUPIC. Obciazenie: KASA 2. Rosnie od wiosny i zaczyna sie …
- [300-02-25] `lenno_fosa_cailin_administracja_299_05`: ### LENNO PLACI ZA ROBOTE - ROZSTRZYGNIECIE GRACZA, KONSEKWENCJA OCZYNSZOWANIA. Skoro nowy winien grosz a nie dni, robocizne trzeba KUPIC. Obciazenie: KASA 2. Rosnie od wiosny i zaczyna sie …
- [300-02-25] `spis_mieszkancow_fosy_299_06`: ### LENNO PLACI ZA ROBOTE - ROZSTRZYGNIECIE GRACZA, KONSEKWENCJA OCZYNSZOWANIA. Skoro nowy winien grosz a nie dni, robocizne trzeba KUPIC. Obciazenie: KASA 2. Rosnie od wiosny i zaczyna sie …
- [300-02-25] `program_rozwoju_fosy_miasteczko_cailin_299_06`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
- [300-02-25] `nina_zielarka_fosy`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
- [300-02-25] `szklane_ogrody_model_zimy_299_06`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
- [300-02-25] `apteka_bagna_fosy_mech_zioła_299_06`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
- [300-02-25] `spis_flory_przesmyku_wystan_nina_299_06`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
- [300-02-25] `maester_wystan_fosy`: ### PYTANIE GRACZA O ZALEGLE RAPORTY (Fosa, lecznica, reszta). SPRAWDZONE W REJESTRZE PRZED ODPOWIEDZIA. ### WNIOSEK: TO NIE SA ZALEGLOSCI. WIEKSZOSC Z NICH NIE MA DOKAD MELDOWAC. W Ksiedze …
