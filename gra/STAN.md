...
## WATKI OTWARTE (581; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- `powiedziec_branowi_i_catelyn_o_nastepstwie_299_09` [otwarty] Bran WIE (09-16). Nie wiedza: Catelyn (opieka nad osoba Krola), Rickon (drugie ogniwo linii, 5 lat, nikt nie m…
