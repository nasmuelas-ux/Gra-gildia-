...
## WATKI OTWARTE (659; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-02-25] `siatka_domu_tally_rozbudowa_299_09`: ### VOID (GM) - TRZY BLEDY W JEDNEJ NOCIE, POPRAWIONE NA WSKAZANIE GRACZA: 'Willa ty jestes w strukturze domu handlowego nie w kancelarii Garrika i to dom do tej pory placil'. ### BLAD 1: na…
- [300-02-25] `kancelaria_namiestnika_299_09`: ### VOID (GM) - TRZY BLEDY W JEDNEJ NOCIE, POPRAWIONE NA WSKAZANIE GRACZA: 'Willa ty jestes w strukturze domu handlowego nie w kancelarii Garrika i to dom do tej pory placil'. ### BLAD 1: na…
- [300-02-25] `siatka_domu_tally_rozbudowa_299_09`: ### STRUKTURA PO POPRAWCE - STAN PRAWDZIWY, NIE NAPRAWIONY: ### (1) WILLA - PION DOMU HANDLOWEGO TALLY. Placi DOM, jak placil od poczatku. Zadnej zmiany kasy, zadnego przeksiegowania. Ukryci…
- [300-02-25] `dom/HAL`: ### STRUKTURA PO POPRAWCE - STAN PRAWDZIWY, NIE NAPRAWIONY: ### (1) WILLA - PION DOMU HANDLOWEGO TALLY. Placi DOM, jak placil od poczatku. Zadnej zmiany kasy, zadnego przeksiegowania. Ukryci…
- [300-02-25] `dom/GARRICK`: ### STRUKTURA PO POPRAWCE - STAN PRAWDZIWY, NIE NAPRAWIONY: ### (1) WILLA - PION DOMU HANDLOWEGO TALLY. Placi DOM, jak placil od poczatku. Zadnej zmiany kasy, zadnego przeksiegowania. Ukryci…
- [300-02-25] `dom/WILLA`: ### STRUKTURA PO POPRAWCE - STAN PRAWDZIWY, NIE NAPRAWIONY: ### (1) WILLA - PION DOMU HANDLOWEGO TALLY. Placi DOM, jak placil od poczatku. Zadnej zmiany kasy, zadnego przeksiegowania. Ukryci…
- [300-02-25] `siatka_domu_tally_rozbudowa_299_09`: ### VOID (GM), DRUGA POPRAWKA GRACZA TEGO WIECZORU: 'to nie sa ZMIANY, tylko Willa jest w strukturze domu Tally'. ### I TO JEST OSTRZEJSZY ZARZUT NIZ POPRZEDNI. Poprzednio zle umiescilem Wil…
- [300-02-25] `poprawki`: ### VOID (GM), DRUGA POPRAWKA GRACZA TEGO WIECZORU: 'to nie sa ZMIANY, tylko Willa jest w strukturze domu Tally'. ### I TO JEST OSTRZEJSZY ZARZUT NIZ POPRZEDNI. Poprzednio zle umiescilem Wil…
- [300-02-25] `siatka_domu_tally_rozbudowa_299_09`: ### VOID TRZECI I NAJGLEBSZY - PYTANIE GRACZA: 'wiesz jaka pozycje zajmuje Willa w domu?'. NIE WIEDZIALEM. SPRAWDZONE. ### WILLA = KANCLERZ-ARCHIWISTA DOMU HANDLOWEGO TALLY, obsadzona przez …
- [300-02-25] `struktura_dom_handlowy_tally_299_05`: ### VOID TRZECI I NAJGLEBSZY - PYTANIE GRACZA: 'wiesz jaka pozycje zajmuje Willa w domu?'. NIE WIEDZIALEM. SPRAWDZONE. ### WILLA = KANCLERZ-ARCHIWISTA DOMU HANDLOWEGO TALLY, obsadzona przez …
- [300-02-25] `kancelaria_namiestnika_299_09`: ### VOID TRZECI I NAJGLEBSZY - PYTANIE GRACZA: 'wiesz jaka pozycje zajmuje Willa w domu?'. NIE WIEDZIALEM. SPRAWDZONE. ### WILLA = KANCLERZ-ARCHIWISTA DOMU HANDLOWEGO TALLY, obsadzona przez …
- [300-02-25] `dom/WILLA`: ### VOID TRZECI I NAJGLEBSZY - PYTANIE GRACZA: 'wiesz jaka pozycje zajmuje Willa w domu?'. NIE WIEDZIALEM. SPRAWDZONE. ### WILLA = KANCLERZ-ARCHIWISTA DOMU HANDLOWEGO TALLY, obsadzona przez …
