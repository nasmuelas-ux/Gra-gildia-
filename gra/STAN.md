...
- [300-02-28] `spis_mieszkancow_fosy_299_06`: ### KARTKE ZGODNOSCI (znak <-> czlowiek) TRZYMA WILLA - rozstrzygniecie gracza. ### UZASADNIENIE PODANE PRZEZ NIA SAMA, I NIE MA NIC WSPOLNEGO Z ZAUFANIEM: 'ja NIE MAM INTERESU W TYM REJESTR…
- [300-02-28] `siatka_domu_tally_rozbudowa_299_09`: ### KARTKE ZGODNOSCI (znak <-> czlowiek) TRZYMA WILLA - rozstrzygniecie gracza. ### UZASADNIENIE PODANE PRZEZ NIA SAMA, I NIE MA NIC WSPOLNEGO Z ZAUFANIEM: 'ja NIE MAM INTERESU W TYM REJESTR…
- [300-02-28] `soltysi_i_samorzad_lenna_299_08`: ### KARTKE ZGODNOSCI (znak <-> czlowiek) TRZYMA WILLA - rozstrzygniecie gracza. ### UZASADNIENIE PODANE PRZEZ NIA SAMA, I NIE MA NIC WSPOLNEGO Z ZAUFANIEM: 'ja NIE MAM INTERESU W TYM REJESTR…
- [300-02-28] `dom/WILLA`: ### KARTKE ZGODNOSCI (znak <-> czlowiek) TRZYMA WILLA - rozstrzygniecie gracza. ### UZASADNIENIE PODANE PRZEZ NIA SAMA, I NIE MA NIC WSPOLNEGO Z ZAUFANIEM: 'ja NIE MAM INTERESU W TYM REJESTR…
- [300-02-28] `spis_mieszkancow_fosy_299_06`: ### MELLA PRZYJMUJE PRACE - PROWADZI REJESTR DNIOWEK. Rozstrzygniecie gracza (propozycja pracy). ### TRZY RZECZY, KTORE POWIEDZIALA PRZED ODPOWIEDZIA: (1) NIE WEZMIE NICZEGO, DO CZEGO TRZEBA…
- [300-02-28] `program_rozwoju_fosy_miasteczko_cailin_299_06`: ### MELLA PRZYJMUJE PRACE - PROWADZI REJESTR DNIOWEK. Rozstrzygniecie gracza (propozycja pracy). ### TRZY RZECZY, KTORE POWIEDZIALA PRZED ODPOWIEDZIA: (1) NIE WEZMIE NICZEGO, DO CZEGO TRZEBA…
- [300-02-28] `szkola_tallych_300_02`: ### MELLA PRZYJMUJE PRACE - PROWADZI REJESTR DNIOWEK. Rozstrzygniecie gracza (propozycja pracy). ### TRZY RZECZY, KTORE POWIEDZIALA PRZED ODPOWIEDZIA: (1) NIE WEZMIE NICZEGO, DO CZEGO TRZEBA…
- [300-02-28] `lenno/MELLA`: ### MELLA PRZYJMUJE PRACE - PROWADZI REJESTR DNIOWEK. Rozstrzygniecie gracza (propozycja pracy). ### TRZY RZECZY, KTORE POWIEDZIALA PRZED ODPOWIEDZIA: (1) NIE WEZMIE NICZEGO, DO CZEGO TRZEBA…
- [300-02-28] `lenno/MELLA`: ### CO POWIEDZIANO MELLI O TYM, KTO TRZYMA KARTKE - ROZSTRZYGNIECIE GRACZA: 'ARCHIWISTKA DOMU, BEZ SZCZEGOLOW'. Prawda, i polowa prawdy. Mella nie dopytywala. ### JEJ ODPOWIEDZ, KTORA NIE JE…
- [300-02-28] `spis_mieszkancow_fosy_299_06`: ### JEDNA KSIEGA, DWA RODZAJE WPISU - PROJEKT POPRAWIONY PRZEZ MELLE I PRZYJETY. Symon zaproponowal DWIE KSIEGI (jawna z imieniem, druga ze znakiem). Mella poprawila, jak ktos, kto prowadzil…
- [300-02-28] `soltysi_i_samorzad_lenna_299_08`: ### JEDNA KSIEGA, DWA RODZAJE WPISU - PROJEKT POPRAWIONY PRZEZ MELLE I PRZYJETY. Symon zaproponowal DWIE KSIEGI (jawna z imieniem, druga ze znakiem). Mella poprawila, jak ktos, kto prowadzil…
- [300-02-28] `siatka_domu_tally_rozbudowa_299_09`: ### CO POWIEDZIANO MELLI O TYM, KTO TRZYMA KARTKE - ROZSTRZYGNIECIE GRACZA: 'ARCHIWISTKA DOMU, BEZ SZCZEGOLOW'. Prawda, i polowa prawdy. Mella nie dopytywala. ### JEJ ODPOWIEDZ, KTORA NIE JE…
