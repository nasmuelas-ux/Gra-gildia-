...
## WATKI OTWARTE (573; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [299-09-15] `spotkanie_ze_stannisem_w_pentos_299_09`: 299-09-15 - TRZY KOREKTY (ROZSZERZENIE IV). || BLAD 1 PROWADZACEGO - KTO JEDZIE. Napisalem, ze to 'nierozstrzygniete i jest to prawdziwa cena'. KSIEGA MOWI WPROST, wpis 299-08-23: list Symon…
- [299-09-15] `swiat`: KOREKTA TRWALEGO FAKTU SWIATA (gracz, 299-09-15), zastepuje note z 299-08-20: BIALY PORT -> BRAAVOS to 4-6 DNI statkiem handlowym przy sprzyjajacych wiatrach, plynac takze noca. BRAAVOS -> P…
- [299-09-15] `robb_stark`: 299-09-15 przedpoludnie - NARADA Z KROLEM PRZED WYJAZDEM NAMIESTNIKA. Bez rzutu (praca wlasna z wlasnym krolem). Symon nie przyszedl z lista zyczen, tylko z PROBLEMEM ROZMIESZCZENIA: nie da …
