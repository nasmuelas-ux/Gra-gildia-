...
- [300-02-27] `catelyn_misja_orle_gniazdo_1127`: ### KOREKTA KOREKTY - PROWADZACY PRZESTAJE ROZSTRZYGAC. Wskazanie gracza: 'jak w Orlim Gniezdzie'. ### PRZYZNANIE: dwa razy pod rzad orzeklem z przekonaniem i dwa razy zle. Najpierw 'nikt ni…
- [300-02-27] `wektor_dolina_arryn_1127`: ### KOREKTA KOREKTY - PROWADZACY PRZESTAJE ROZSTRZYGAC. Wskazanie gracza: 'jak w Orlim Gniezdzie'. ### PRZYZNANIE: dwa razy pod rzad orzeklem z przekonaniem i dwa razy zle. Najpierw 'nikt ni…
- [300-02-27] `poprawki`: ### KOREKTA KOREKTY - PROWADZACY PRZESTAJE ROZSTRZYGAC. Wskazanie gracza: 'jak w Orlim Gniezdzie'. ### PRZYZNANIE: dwa razy pod rzad orzeklem z przekonaniem i dwa razy zle. Najpierw 'nikt ni…
- [300-02-27] `polnoc/catelyn_stark`: ### KOREKTA KOREKTY - PROWADZACY PRZESTAJE ROZSTRZYGAC. Wskazanie gracza: 'jak w Orlim Gniezdzie'. ### PRZYZNANIE: dwa razy pod rzad orzeklem z przekonaniem i dwa razy zle. Najpierw 'nikt ni…
- [300-02-27] `catelyn_stark`: ### ROZSTRZYGNIECIE GRACZA, KONCZACE SPRZECZNOSC: 'ONA MIALA BYC W DORZECZU I NEGOCJOWAC'. ### STAN WPISANY: LADY CATELYN JEST W DORZECZU I NEGOCJUJE. Obraz A (pisma pierwszoosobowe Symona z…
- [300-02-27] `catelyn_misja_orle_gniazdo_1127`: ### ROZSTRZYGNIECIE GRACZA, KONCZACE SPRZECZNOSC: 'ONA MIALA BYC W DORZECZU I NEGOCJOWAC'. ### STAN WPISANY: LADY CATELYN JEST W DORZECZU I NEGOCJUJE. Obraz A (pisma pierwszoosobowe Symona z…
- [300-02-27] `wektor_dolina_arryn_1127`: ### ROZSTRZYGNIECIE GRACZA, KONCZACE SPRZECZNOSC: 'ONA MIALA BYC W DORZECZU I NEGOCJOWAC'. ### STAN WPISANY: LADY CATELYN JEST W DORZECZU I NEGOCJUJE. Obraz A (pisma pierwszoosobowe Symona z…
- [300-02-27] `traktat_handlowy_z_dorzeczem_300_02`: ### ROZSTRZYGNIECIE GRACZA, KONCZACE SPRZECZNOSC: 'ONA MIALA BYC W DORZECZU I NEGOCJOWAC'. ### STAN WPISANY: LADY CATELYN JEST W DORZECZU I NEGOCJUJE. Obraz A (pisma pierwszoosobowe Symona z…
