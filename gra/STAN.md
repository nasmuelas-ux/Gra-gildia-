...
- [300-03-02] `dom/HAL`: ### NASIENIE - RUSZONE WSZYSTKIE PIEC KIERUNKOW, 300-03-02. Bez rzutow (same wyprawienia; odpowiedzi beda pozniej). || ### (1) CERWYN - PYTANIE PRZY STOLE DZIS WIECZOREM. ### Kanal: rozmowa.…
- [300-03-02] `lenno/HARL`: ### NASIENIE - RUSZONE WSZYSTKIE PIEC KIERUNKOW, 300-03-02. Bez rzutow (same wyprawienia; odpowiedzi beda pozniej). || ### (1) CERWYN - PYTANIE PRZY STOLE DZIS WIECZOREM. ### Kanal: rozmowa.…
- [300-03-02] `przeglad_geopolityczny_raporty_krolestwa_299_06`: ### PRZEGLAD WATKOW POZA FOSA - na pytanie gracza, 300-03-02. Bez rzutow (czytanie listy CO SLEDZIMY). || ## (A) DWA FILARY BEZ KANALU - zasada 34: bez kanalu nie ma wiadomosci ## ### DAENER…
- [300-03-02] `polnocna_cytadela_theomore_przystan_wilka_299_08`: ### PRZEGLAD WATKOW POZA FOSA - na pytanie gracza, 300-03-02. Bez rzutow (czytanie listy CO SLEDZIMY). || ## (A) DWA FILARY BEZ KANALU - zasada 34: bez kanalu nie ma wiadomosci ## ### DAENER…
- [300-03-02] `roose_bolton`: ### PRZEGLAD WATKOW POZA FOSA - na pytanie gracza, 300-03-02. Bez rzutow (czytanie listy CO SLEDZIMY). || ## (A) DWA FILARY BEZ KANALU - zasada 34: bez kanalu nie ma wiadomosci ## ### DAENER…
- [300-03-02] `przeglad_geopolityczny_raporty_krolestwa_299_06`: ### ROZKAZY NA WATKI POZA FOSA - 300-03-02. Bez rzutow (same wyprawienia). || ### (A1) DAENERYS - PYTANIE DOKLADA SIE DO LISTU DO NESTY, KTORY WYCHODZI DZIS. ### ⚠ SPRAWDZONE: listy do Nesty…
