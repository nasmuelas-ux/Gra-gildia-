...
## ⚠️ 35 ZASAD SILNIKA — `gra/PROWADZENIE.md`, sekcja od "TRZYDZIESCI PIEC ZASAD"
...
- [300-02-25] `system_oswiaty_polnocy_struktura_299_06`: ### PRZYTULEK WCHLONIETY PRZEZ SZKOLY - ROZSTRZYGNIECIE GRACZA, PRZEGLAD WATKOW. Watek `przytulek_dzieci_bezrodziny` (298-07-02, marzenie polozone septonowi Owenowi po chrzcie Lyry: dom dla …
- [300-02-25] `eskadra_ktora_lowi_koszt_floty_299_09`: ### POLACZENIE WATKOW - ROZSTRZYGNIECIE GRACZA, PRZEGLAD WATKOW. Stary watek `marynarka_ostrze_na_wyspy_1113` (298-11-13: 'marynarka jako realne ostrze na nagie Wyspy Zelazne, przyszly wieks…
- [300-02-25] `program_okretow_polnocy_299_08`: ### WCHLONIETO CEL WOJENNY (rozstrzygniecie gracza). Stary watek `marynarka_ostrze_na_wyspy_1113` zamkniety, jego tresc idzie tu i do watku Dustinportu. Dla Programu znaczy to jedno konkretn…
