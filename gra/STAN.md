...
## WATKI OTWARTE (585; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- `kanon_wychowania_rodziny_krolewskiej_299_09` [otwarty] KANON NAUKI RODU STARKOW - drabina czterech szczebli z proba na kazdym (wzor programu wychowankow Tally); jawn…
...
- `mistrz_nauki_tytul_czy_cisza_299_09` [otwarty] Luwin Mistrzem Nauki: tytul jawnie (Stare Miasto odczytuje, zegar rusza lata za wczesnie) czy robota bez tytul…

## OSTATNIE WPISY DZIENNIKA
- [299-09-16] `kanon_wychowania_rodziny_krolewskiej_299_09`: 299-09-16 WATEK ZALOZONY (projekt gracza, spisany jako gra/kanon_wychowania_rodziny_krolewskiej.md). Bez rzutu (praca wlasna). POWSTAL Z ROZDZIELENIA, KTORE ZROBIL GRACZ: ochrona dzieci krol…
- [299-09-16] `kanon_wychowania_rodziny_krolewskiej_299_09`: 299-09-16 - REDAKCJA II KANONU, PO DWOCH SLUSZNYCH ZARZUTACH GRACZA. Bez rzutu. || POPRAWKA I - WYCOFANA JAWNOSC KANONU. Bledna byla sama zasada, nie sformulowanie: JAWNOSC JEST BRONIA TAM, …
- [299-09-16] `kolegium_polnocy_maesterowie_299_09`: 299-09-16 WATEK ZALOZONY (projekt gracza, spisany jako gra/kolegium_polnocy_maesterowie.md). Bez rzutu. WLASNA WERSJA CYTADELI DLA WOLNEJ POLNOCY. || NAZWA I DOKTRYNA NACZELNA: KOLEGIUM POLN…
