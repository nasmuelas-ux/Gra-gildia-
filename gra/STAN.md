...
## TERAZ
- **Data:** 300-01-29 ranek · zima (300)
- **Miejsce:** BIALY PORT -> WINTERFELL. Dzien wyjazdu (przybycie ~300-02-06). List Krola dogonil Symona przed wyjazdem.
- **Postac:** Symon Tally, l.24 — Lord Symon Tally, Namiestnik Krola Polnocy (Hand of the King in the North)
- **Zdrowie 85 · Sytosc 16 · Zmeczenie 10**
...
## WATKI OTWARTE (636; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
