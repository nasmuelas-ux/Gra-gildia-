...
## WATKI OTWARTE (646; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-02-07] `rachunek_drogi_i_liczba_dla_rickona_300_02`: ### RACHUNEK DROGI POLICZONY I ZAMKNIETY - 300-02-07 przedpoludnie, Winterfell. Bez rzutu (praca wlasna, rachunki 10). ### || LICZBY DOWIEDZIONE, NIE ZGADNIETE: WINTERFELL->BIALY PORT = 7 DN…
- [300-02-07] `rickon_stark`: ### LICZBA DLA RICKONA - POLICZONA PRZED POLUDNIEM, DO PODANIA PRZY KOLACJI (termin dany rano). Sprawdzona dwa razy, 'bo raz juz podalem temu dziecku liczbe, zanim skonczylem liczyc'. ### ||…
- [300-02-07] `maester_aemon`: ### LIST NAMIESTNIKA DO MAESTERA AEMONA - 300-02-07, Winterfell, REKA WLASNA, pisany dwa razy ('pierwszy raz wyszlo zapewnienie, a zapewnienie jest tym, co Aemon dostaje od wszystkich; drugi…
- [300-02-07] `mur_mance_rayder_i_lud_za_murem_299_09`: 300-02-07 - PYTANIE 'KTO DZIS ROZKAZUJE NA MURZE' POSTAWIONE DRUGA DROGA. Do Osrica poszlo o switu; po poludniu wyjezdza kurier z listem WLASNEJ REKI do maestera Aemona z tym samym pytaniem.…
- [300-02-07] `wielka_rada_porzadek_obrad_300_04`: ### PORZADEK OBRAD ZREDUKOWANY DO PIECIU WIAZEK - ROZSTRZYGNIETE PRZY KROLU, 300-02-07 poludnie. ### || PROBLEM POSTAWIONY PRZEZ KROLA: 'Czterdziesci pozycji, czternastu ludzi, jeden dzien. …
- [300-02-07] `theomore_mistrz_nauki`: ### THEOMORE STAJE PRZY REJESTRZE NA WIELKIEJ RADZIE - rozstrzygniete 300-02-07 przy Krolu. List wychodzi tego samego dnia do Bialego Portu. ### || DLACZEGO NIE KTO INNY: OSRIC zostaje pod M…
- [300-02-07] `ramsay_bastard_dreadfort_watch_299_08`: ### 300-02-07 - LIST DO HALA: WYKUPIC WEKSEL DANY BOLTONOM. ### PODSTAWA W KSIEDZE: 299-10-20, Dreadfort, zamiec (pogoda 1) - 'POSTOJ PRZEDLUZONY OPLACONY WEKSLEM NA DOM TALLY; Roose przyjal…
