...
## TERAZ
- **Data:** 300-02-25 noc · zima (300)
- **Miejsce:** FOSA CAILIN. Cerwyn 2.-5. III. Dzien Bilansu 300-03-01. Wyjazd 300-03-07.
- **Postac:** Symon Tally, l.24 — Lord Symon Tally, Namiestnik Krola Polnocy (Hand of the King in the North)
- **Zdrowie 76 · Sytosc 14 · Zmeczenie 91**
...
## WATKI OTWARTE (665; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-02-27] `soltysi_i_samorzad_lenna_299_08`: ### TRZY PROPOZYCJE BURMISTRZA ZATWIERDZONE W CALOSCI - ROZSTRZYGNIECIE GRACZA ('tak robmy'): (1) MIASTO WYBIERA NOWEGO WAGOWEGO, HERWIN SZALA PRZESTAJE STAC PRZY SZALI. Doktryna: kto zarzad…
- [300-02-27] `lenno/HERWIN SZALA`: ### TRZY PROPOZYCJE BURMISTRZA ZATWIERDZONE W CALOSCI - ROZSTRZYGNIECIE GRACZA ('tak robmy'): (1) MIASTO WYBIERA NOWEGO WAGOWEGO, HERWIN SZALA PRZESTAJE STAC PRZY SZALI. Doktryna: kto zarzad…
- [300-02-27] `program_rozwoju_fosy_miasteczko_cailin_299_06`: ### TRZY PROPOZYCJE BURMISTRZA ZATWIERDZONE W CALOSCI - ROZSTRZYGNIECIE GRACZA ('tak robmy'): (1) MIASTO WYBIERA NOWEGO WAGOWEGO, HERWIN SZALA PRZESTAJE STAC PRZY SZALI. Doktryna: kto zarzad…
- [300-02-27] `pakt_obronny_polnoc_dorzecze_299_07`: ### VOID (GM) - WSKAZANIE GRACZA: 'Blackfish 8,5 miesiaca, bo nikt nie dal mu adresu ani rytmu - DURNE WYJASNIENIE. Postacie zewnetrzne, jak czegos nie widza, wysylaja list do Korony ogolny …
- [300-02-27] `pakt_obronny_polnoc_dorzecze_299_07`: ### PYTANIE DO BERONA KARTA SIEDMIODNIOWA - ROZSTRZYGNIECIE GRACZA. Dwa pytania, nie jedno. ### (1) JEDNORAZOWO: czy w kancelarii Korony leza jakiekolwiek pisma od BRYNDENA TULLY'EGO albo z …
- [300-02-27] `kancelaria_namiestnika_299_09`: ### VOID (GM) - WSKAZANIE GRACZA: 'Blackfish 8,5 miesiaca, bo nikt nie dal mu adresu ani rytmu - DURNE WYJASNIENIE. Postacie zewnetrzne, jak czegos nie widza, wysylaja list do Korony ogolny …
- [300-02-27] `kancelaria_namiestnika_299_09`: ### PYTANIE DO BERONA KARTA SIEDMIODNIOWA - ROZSTRZYGNIECIE GRACZA. Dwa pytania, nie jedno. ### (1) JEDNORAZOWO: czy w kancelarii Korony leza jakiekolwiek pisma od BRYNDENA TULLY'EGO albo z …
- [300-02-27] `poprawki`: ### VOID (GM) - WSKAZANIE GRACZA: 'Blackfish 8,5 miesiaca, bo nikt nie dal mu adresu ani rytmu - DURNE WYJASNIENIE. Postacie zewnetrzne, jak czegos nie widza, wysylaja list do Korony ogolny …
- [300-02-27] `poprawki`: ### PYTANIE DO BERONA KARTA SIEDMIODNIOWA - ROZSTRZYGNIECIE GRACZA. Dwa pytania, nie jedno. ### (1) JEDNORAZOWO: czy w kancelarii Korony leza jakiekolwiek pisma od BRYNDENA TULLY'EGO albo z …
- [300-02-27] `pakt_obronny_polnoc_dorzecze_299_07`: ### TRASA ODPOWIEDZI BERONA ROZSTRZYGNIETA - GRACZ: 'niech przygotuje to w Winterfell'. Odpowiedz NIE goni Symona po trakcie: czeka przygotowana i zapieczetowana w Winterfell, do rak wlasnyc…
- [300-02-27] `kancelaria_namiestnika_299_09`: ### TRASA ODPOWIEDZI BERONA ROZSTRZYGNIETA - GRACZ: 'niech przygotuje to w Winterfell'. Odpowiedz NIE goni Symona po trakcie: czeka przygotowana i zapieczetowana w Winterfell, do rak wlasnyc…
- [300-02-27] `korona/BERON`: ### TRASA ODPOWIEDZI BERONA ROZSTRZYGNIETA - GRACZ: 'niech przygotuje to w Winterfell'. Odpowiedz NIE goni Symona po trakcie: czeka przygotowana i zapieczetowana w Winterfell, do rak wlasnyc…
