...
## WATKI OTWARTE (644; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-02-07] `rickon_stark`: 300-02-07 ranek, Winterfell - SYMON WRACA DO RICKONA PO STU TRZYDZIESTU OSMIU NOCACH. Bez rzutu (dziecko domu, cieply nawyk sprawdzony). Znaleziony nie u psow, lecz ZA psiarnia, w waskim prz…
- [300-02-07] `rickon_drugie_ogniwo_linii_299_09`: 300-02-07 - NOWY KIJ I ODWROCENIE NARZEDZIA. Bez rzutu. || STARY KIJ: lezal na stole w wielkiej sali od 300-02-06, gdy Rickon polozyl go ze slowami 'Skonczylo mi sie miejsce' i odszedl; sluz…
- [300-02-07] `swiat`: 300-02-07 ranek - TERMIN WLASNY NAMIESTNIKA: DO KOLACJI DZIS Symon ma podac Rickonowi Starkowi LICZBE nocy, ktore zostaje w Winterfell. Zrodla rachunku: wola Krola + droga na Wielka Rade (1.…
- [300-02-07] `rejestr_rozwoju_polnocy_300_02`: ### REJESTR ZUPELNY POMYSLOW ROZWOJOWYCH POLNOCY - ZALOZONY 300-02-07, WINTERFELL, PRZY KROLU. Bez rzutu (praca wlasna, redakcja). ### || POWOD ZALOZENIA, PRZYZNANY WPROST NA PYTANIE GRACZA …
- [300-02-07] `przystanie_ladunkowe_wschodu_300_02`: ### PRZYSTANIE LADUNKOWE NAD KAZDA WIEKSZA RZEKA WSCHODU - POZYCJA NOWA, POSTAWIONA 300-02-07 (pomysl gracza). ### || CZYM JEST, A CZYM NIE: nie port. ### POMOST + WAGA + ZADASZONY SKLAD NA …
- [300-02-07] `spichlerz_polnocy_dwa_etapy_300_02`: ### SPICHLERZ POLNOCY - PRZEDEFINIOWANY PRZEZ GRACZA NA DWA ETAPY. NIE JEST GMACHEM. 300-02-07. ### || ### ETAP I - SKLADY W MIASTACH. ### Pod prawem o skladach (siedem lat, piec rozstrzygni…
- [300-02-07] `zakaz_wylacznosci_faktora_i_porty_jako_komory_300_02`: ### DWIE ZASADY USTROJOWO-HANDLOWE POSTAWIONE 300-02-07 (obie z polecenia gracza). ### || ## 1. ZAKAZ WYLACZNOSCI Z FAKTOREM ## ### ZADEN FAKTOR OBCEGO DOMU NIE DOSTAJE W POLNOCY WYLACZNOSCI…
- [300-02-07] `robb_stark`: 300-02-07 ranek, solar ojca - SYMON SKLADA KROLOWI CALA RELACJE Z BRAAVOS I PENTOS. Bez rzutu (rozmowa z krolem, ktory sam poprosil; material spisany 299-12-30 przed rozmowa z kimkolwiek). O…
- [300-02-07] `wielka_rada_porzadek_obrad_300_04`: ### PORZADEK OBRAD WIELKIEJ RADY POLNOCY (1. dnia Czwartego Miesiaca 300) - PROJEKT SPISANY 300-02-07 W WINTERFELL, PRZY KROLU. Pierwszy raz od 53 dni. ### || TERMIN KROLA: ### 'TRZYMAM CIE …
- [300-02-07] `traktat_handlowy_z_dorzeczem_300_02`: ### TRAKTAT HANDLOWY MIEDZY POLNOCA A DORZECZEM - OSOBNY OD SOJUSZU, NA CENE STALA. Pomysl gracza, postawiony 300-02-07. ### || W TECE NAMIESTNIKA STAL OD 299-09-14 JAKO TRZY SLOWA BEZ TRESC…
- [300-02-07] `cztery_puste_miejsca_na_nazwiska_300_02`: ### CZTERY PRZEDSIEWZIECIA BEZ NAZWISKA - LISTA OTWARTA 300-02-07 ('szukamy nazwisk'). ### 'Przedsiewziecie bez nazwiska nie jest przedsiewzieciem. Jest zamiarem.' || PUSTE MIEJSCA: (1) PRZY…
- [300-02-07] `odbudowa_fosy_cailin_dom_tally_1127`: 300-02-07 - SCALENIE, KTORE POWINNO BYLO NASTAPIC POLTORA ROKU TEMU: ### WEZEL PRZELADUNKOWY NA BIALYM NOZU = PRZYSTAN WILKA. ### To nie sa dwa przedsiewziecia do polaczenia - to JEDNO, prow…
