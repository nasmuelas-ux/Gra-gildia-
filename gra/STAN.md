...
## WATKI OTWARTE (684; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- [300-03-02] `korona/OSRIC`: ### DWA PISMA WYCHODZA + ROZSTRZYGNIECIE FORMY ZWROTU 695. 300-03-02, przedpoludnie. Bez rzutow. || ## (1) PYTANIE DO OSRICA - DOLACZONE, NIE OSOBNE ## Tresc: czy w DARZE i przy zamkach Stra…
- [300-03-02] `spichlerz_polnocy_mistrz_zapasow_zimowych_300_02`: ### 695 WRACA DO HALA I SCHODZI ZE STOLU SYMONA. 300-03-02. Rozstrzygniecie gracza. Bez rzutow. || ## TO JEST POWROT DO REGULY, NIE NOWA DECYZJA. ## Konstrukcja z 300-01-26 brzmi: 'DYREKTOR …
- [300-03-02] `wielka_rada_porzadek_obrad_300_04`: ### 695 WRACA DO HALA I SCHODZI ZE STOLU SYMONA. 300-03-02. Rozstrzygniecie gracza. Bez rzutow. || ## TO JEST POWROT DO REGULY, NIE NOWA DECYZJA. ## Konstrukcja z 300-01-26 brzmi: 'DYREKTOR …
- [300-03-02] `dom/HAL`: ### 695 WRACA DO HALA I SCHODZI ZE STOLU SYMONA. 300-03-02. Rozstrzygniecie gracza. Bez rzutow. || ## TO JEST POWROT DO REGULY, NIE NOWA DECYZJA. ## Konstrukcja z 300-01-26 brzmi: 'DYREKTOR …
- [300-03-02] `korona/GAWEN`: ### 695 WRACA DO HALA I SCHODZI ZE STOLU SYMONA. 300-03-02. Rozstrzygniecie gracza. Bez rzutow. || ## TO JEST POWROT DO REGULY, NIE NOWA DECYZJA. ## Konstrukcja z 300-01-26 brzmi: 'DYREKTOR …
- [300-03-02] `spichlerz_polnocy_mistrz_zapasow_zimowych_300_02`: ### LISTA ZBOZ SIEWNYCH - ZASADA BYLA WPISANA, LISTA NIE. 300-03-02. Pytanie gracza. Bez rzutow. || ## STAN SPRAWDZONY: ## Do prawa wszedl dzis DOPISEK O PREFERENCJI ('kupujemy i przyjmujemy…
- [300-03-02] `prawo_o_skladach_zboza_299_09`: ### LISTA ZBOZ SIEWNYCH - ZASADA BYLA WPISANA, LISTA NIE. 300-03-02. Pytanie gracza. Bez rzutow. || ## STAN SPRAWDZONY: ## Do prawa wszedl dzis DOPISEK O PREFERENCJI ('kupujemy i przyjmujemy…
- [300-03-02] `maester_luwin`: ### LISTA ZBOZ SIEWNYCH - ZASADA BYLA WPISANA, LISTA NIE. 300-03-02. Pytanie gracza. Bez rzutow. || ## STAN SPRAWDZONY: ## Do prawa wszedl dzis DOPISEK O PREFERENCJI ('kupujemy i przyjmujemy…
- [300-03-02] `lenno/WYSTAN`: ### LISTA ZBOZ SIEWNYCH - ZASADA BYLA WPISANA, LISTA NIE. 300-03-02. Pytanie gracza. Bez rzutow. || ## STAN SPRAWDZONY: ## Do prawa wszedl dzis DOPISEK O PREFERENCJI ('kupujemy i przyjmujemy…
- [300-03-02] `spichlerz_polnocy_mistrz_zapasow_zimowych_300_02`: ### LISTA ZBOZ SIEWNYCH WYSZLA - 300-03-02, tym samym kanalem co ogloszenie o przeliczniku (slupy i komory, plus odpis do kancelarii w Winterfell). Bez rzutu - wlasny rozkaz, wlasny kanal. |…
- [300-03-02] `prawo_o_skladach_zboza_299_09`: ### LISTA ZBOZ SIEWNYCH WYSZLA - 300-03-02, tym samym kanalem co ogloszenie o przeliczniku (slupy i komory, plus odpis do kancelarii w Winterfell). Bez rzutu - wlasny rozkaz, wlasny kanal. |…
- [300-03-02] `karstark_linia_pekniecia_wschod_299_08`: ### LISTA ZBOZ SIEWNYCH WYSZLA - 300-03-02, tym samym kanalem co ogloszenie o przeliczniku (slupy i komory, plus odpis do kancelarii w Winterfell). Bez rzutu - wlasny rozkaz, wlasny kanal. |…
