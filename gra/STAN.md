...
- **WYSZEDL 300-02-07 - 25 DNI CISZY** — POSLANIEC ZA MUR DO MANCE'A RAYDERA - o DELEGACJE PRZED GLOWNA BRAME. Rozkaz wydany rano 300-02-07, zameldowany Krolowi tego samego dnia slowami: 'NIE MOWIE WAM, ZE SIE UDA. MOWIE, ZE WYSZLO'. RAZEM Z NIM: TLUMACZ ZATRZYMANY, PLATNY Z KASY 3 (zold pod Murem, biezaco, potwierdzony 300-02-15) - o co OSRIC PROSIL NA PISMIE I CZEKAL. PODSTAWA: stanowisko Symona przed Krolem 300-02-06 - 'poslac kogos za Mur do Mance'a Raydera PO ICH RELACJE i poprosic o DOWOD W POSTACI DOSTARCZENIA NIEUMARLYCH'. KANAL: nie ma kruka za Mur. Czlowiek wychodzi i wraca albo nie wraca. Odpowiedz wroci PRZEZ OSRICA - i dlatego jego zalegly meldunek VII jest dzis najwazniejsza cisza w grze. · _kto:_ **poslaniec -> MANCE RAYDER -> OSRIC -> SYMON** · _zamyka:_ delegacja przed glowna brama ALBO odmowa ALBO poslaniec, ktory nie wrocil - kazde z trzech jest odpowiedzia **⚠ OTWARTE - NAJWIEKSZA NIEZAREJESTROWANA SPRAWA GRY**
...
- [300-03-03] `maester_aemon`: ### PYTANIE GRACZA: 'pisalem do niego, ze czlonek jego rodziny zyje pod Pentos'. SPRAWDZONE WYCZERPUJACO - TAKIEGO PISMA W ZAPISIE NIE MA. ### PELNA LISTA WSZYSTKIEGO, CO POSZLO NA MUR: (1) …
- [300-03-03] `wspolnictwo_nesta`: ### PYTANIE GRACZA: 'pisalem do niego, ze czlonek jego rodziny zyje pod Pentos'. SPRAWDZONE WYCZERPUJACO - TAKIEGO PISMA W ZAPISIE NIE MA. ### PELNA LISTA WSZYSTKIEGO, CO POSZLO NA MUR: (1) …
- [300-03-03] `wektor_stannis_zlamany_sojusznik_1127`: ### PYTANIE GRACZA: 'pisalem do niego, ze czlonek jego rodziny zyje pod Pentos'. SPRAWDZONE WYCZERPUJACO - TAKIEGO PISMA W ZAPISIE NIE MA. ### PELNA LISTA WSZYSTKIEGO, CO POSZLO NA MUR: (1) …
- [300-03-03] `polnoc/robb_stark`: ### PYTANIE GRACZA: 'pisalem do niego, ze czlonek jego rodziny zyje pod Pentos'. SPRAWDZONE WYCZERPUJACO - TAKIEGO PISMA W ZAPISIE NIE MA. ### PELNA LISTA WSZYSTKIEGO, CO POSZLO NA MUR: (1) …
...
- [300-03-03] `howland_reed`: ### PYTANIE GRACZA: 'a Osric pytajacy Mance Raydera? Taki list kojarzysz?'. ODPOWIEDZ: NIE SKOJARZYLEM - I TO JEST NAJWIEKSZA DZIURA CALEGO PRZEGLADU. || ### CO JEST W KSIEDZE: 300-02-06, pr…
- [300-03-03] `korona/OSRIC`: ### PYTANIE GRACZA: 'a Osric pytajacy Mance Raydera? Taki list kojarzysz?'. ODPOWIEDZ: NIE SKOJARZYLEM - I TO JEST NAJWIEKSZA DZIURA CALEGO PRZEGLADU. || ### CO JEST W KSIEDZE: 300-02-06, pr…
- [300-03-03] `polnoc/robb_stark`: ### PYTANIE GRACZA: 'a Osric pytajacy Mance Raydera? Taki list kojarzysz?'. ODPOWIEDZ: NIE SKOJARZYLEM - I TO JEST NAJWIEKSZA DZIURA CALEGO PRZEGLADU. || ### CO JEST W KSIEDZE: 300-02-06, pr…
