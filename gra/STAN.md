...
- [300-02-25] `jon_snow_po_drugiej_stronie_299_09`: ### PODNIESIONY DO FILARU GLOWNEGO - ROZSTRZYGNIECIE GRACZA: 'watek Jona Snowa powinien byc jako glowny osobny'. ### DOTAD LEZAL JAKO POZYCJA W 'CO SLEDZIMY' z kanalem 'Osric/Straz' i ostatn…
- [300-02-25] `placowka_rozdroze_tally_299_07`: ### DOPASOWANE DO KSIEGI - ROZSTRZYGNIECIE GRACZA. W spisie kanalow stalo kategoryczne 'DWOR KROLEWSKIEJ PRZYSTANI - NIE MA GO WCALE', a osobno lezala placowka Tallych na Rozdrozu. Oba zdani…
- [300-02-25] `w_orbicie/lord_wyman_manderly`: ### VOID PODWOJNY (GM) - I GORSZY NIZ POPRZEDNIE, BO NIE POMYLILEM SIE W ZAPISIE, TYLKO GO WYMYSLILEM. GRACZ: 'Wylis zostal wymieniony podczas wojny'. Sprawdzone: na liscie jencow Korony Pol…
- [300-02-25] `poprawki`: ### ZASADA 1 MA LUKE, KTORA DZIS ZOBACZYLEM NA SOBIE. Brzmi 'nie twierdze, nie sprawdziwszy' i chroni przed zapomnieniem tego, co w ksiedze JEST. Nie chroni przed czyms innym: przed wpisanie…
- [300-02-25] `karstark_linia_pekniecia_wschod_299_08`: ### FILAR: RICKARD KARSTARK. Scalone na polecenie gracza - jeden czlowiek mial PIEC teczek. Wchloniete: zraniona duma po publicznej przegranej sporu (299-06) · jawny wrog osobisty (298-10) ·…
- [300-02-25] `sprawa_rymana_justycjariusz_299_08`: ### FILAR: SPRAWA RYMANA. Scalone na polecenie gracza - trzy watki w jeden. Wchloniete: wznowienie sprawy (299-06) · krzywda wdowy u Justycjariusza (299-08) · dylemat wyznania Nescie. Filar …
- [300-02-25] `projekt_cailin`: ### PROJEKT FOSY CAILIN ROZLOZONY NA ZADANIA - polecenie gracza. Pelny tekst: gra/zadania_fosy_cailin_300_02.md ### RAMA (Wyman, 300-01-26, czytajac plan palcem): 'Co to jest? Bo to nie jest…
- [300-02-25] `projekt_cailin`: ### ETAPY WDROZENIA DOPISANE (polecenie gracza: 'ale takze etapy wdrozenia - bo to jest projekt'). Pelny tekst: gra/zadania_fosy_cailin_300_02.md, czesc druga. Zbudowane z projekt_cailin.md …
- [300-02-25] `projekt_cailin`: ### PORZADEK BUDOWY - CZESC TRZECIA (gracz: 'ale tego jest tam wiecej, pomysl co jest etapami budowy'). Slusznie - czesc druga byla lukiem strategicznym, nie porzadkiem rzemieslniczym. To sa…
- [300-02-25] `projekt_cailin`: ### LANCUCH DWOCH MORZ - CZESC CZWARTA (wyliczenie gracza: Gorcy Port, odcinek Tally, odcinek Tally-Cerwyn-Przystan Wilka, Cailin-Bialy Port, zdolnosc przenoszenia ciezkich towarow i toczeni…
- [300-02-25] `projekt_cailin`: ### TRZY LICZBY LANCUCHA WPISANE (polecenie gracza: 'wpisz te trzy liczby'). Pelny tekst w gra/zadania_fosy_cailin_300_02.md. ### ZASADA NADRZEDNA: CO SIE KLADZIE RAZ - BUDUJE SIE NA DOCELOW…
