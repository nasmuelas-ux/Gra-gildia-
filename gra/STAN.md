...
- **Zdrowie 97 · Sytosc 34 · Zmeczenie 18**
...
## WATKI OTWARTE (576; ostatnie 45 — pelna lista: `python3 gra/db.py otwarte`)
...
- `siatka_domu_tally_rozbudowa_299_09` [otwarty] Siatka Domu Tally - odpowiedz Garricka: znaki zamiast imion (wymaga zgody Willi), dwaj skladajacy z wychowanko…

## OSTATNIE WPISY DZIENNIKA
- [299-09-15] `prawo_sukcesji_polnocy_299_08`: 299-09-15 wieczor - GRANICE REGENCJI SPISANE (gra/granice_regencji_299_09_15.md). Bez rzutu (praca wlasna, redakcja prawa). To jest DRUGA POLOWA prawa nastepstwa ratyfikowanego 299-08-17: ta…
- [299-09-15] `wylaczenie_namiestnika_z_regencji_299_09`: 299-09-15 - SYMON WYPISUJE SIEBIE Z REGENCJI, POPRAWIAJAC WLASNE PRAWO. Bez rzutu. Czesc VIII dokumentu gra/granice_regencji_299_09_15.md. || CO POPRAWIA: w prawie nastepstwa z 299-08-13 SAM…
- [299-09-15] `postac`: 299-09-15 wieczor - SYMON SPISUJE GRANICE WLASNEJ MOZLIWEJ WLADZY I WYPISUJE SIEBIE Z REGENCJI. Postawa, nie decyzja urzedowa. To trzeci raz, gdy Symon dobrowolnie odbiera sobie wladze, ktor…
- [299-09-15] `hal_sierota`: 299-09-15 noc - LIST DO HALA: RE-TASKOWANIE PLACOWKI W CZARNYM ZAMKU (gra/dwa_listy_na_mur_299_09_15.md, LIST I). Bez rzutu (wlasny czlowiek, zwykle polecenie). Pismo DOMOWE, Kasa 1, nie pap…
- [299-09-15] `mur_mance_rayder_i_lud_za_murem_299_09`: 299-09-15 noc - LIST DO MAESTERA AEMONA NAPISANY (gra/dwa_listy_na_mur_299_09_15.md, LIST II). Bez rzutu (odpowiedz na jego wlasne pismo). || FORMA - ROZSTRZYGNIECIE, KTORE DECYDUJE O CALYM …
- [299-09-15] `maester_aemon`: 299-09-15 - ODPOWIEDZ SYMONA NA LIST AEMONA Z 299-09-07 (kruk, pismo prywatne, nie papier Korony). Pierwszy kontakt zwrotny z Czarnym Zamkiem od czerwca. Tresc i konstrukcja: patrz watek mur…
- [299-09-15] `sansa_stark`: 299-09-15 poznym wieczorem, Winterfell - SYMON WRACA DO SANSY, ZEBY ZDAC JEJ RACHUNEK. Bez rzutu (dotrzymanie obietnicy wobec zyczliwej osoby; jego staly rejestr powsciagliwosci wobec zranio…
