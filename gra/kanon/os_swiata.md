...
## KONKRETNE OKNA (kalendarz gry; przybliżone, dostarczane z opóźnieniem)
_Daty PLIO są rozmyte/sporne — to kalibracja gry, nie ewangelia. „Udział" = jak
Symon realnie może wejść, nie tylko patrzeć._

| Data gry | Wydarzenie | Udział Symona |
|---|---|---|
| **297-11** (za ~2–6 tyg gry) | **Biały kruk Cytadeli** — koniec lata / jesień ogłoszona | **BEZPOŚREDNI** — prowiant zimowy to jego atut; kruk podbija cały jego filar |
| 297-11→12 | Przedzimie głębsze; słabe plotki dworskie (długi króla u Lannisterów / Żelaznego Banku) | Echo (relevantne dla Nesty/Banku); tło |
| **298-02/03** | **Śmierć Namiestnika Jona Arryna** (KP); wieść do Białego Portu ~298-03/04 | Świadek + polityczne drganie; plotka/statek |
| **298-04→06** (wiosna-lato) | **Król Robert jedzie na Północ do Winterfell**, mianuje Neda Namiestnikiem; Manderly zaangażowany | **REALNY SZCZEBEL** — prowiantowanie/koordynacja przejazdu, prestiż, może retinue Manderlych → drabina ku Winterfell |
| 298-lato→jesień | Ned na południe; Bran spada; intrygi KP | Wieści z opóźnieniem |
| **299** (~wiosna-lato) | **Robert umiera; Ned upada; Robb Królem Północy ZWOŁUJE CHORĄGWIE; Biały Port MOBILIZUJE** | **WIELKIE OKNO** — prowiantowanie/logistyka/finanse/underwriting wojenny = jego dokładny atut na skali wojennej; okazja i śmiertelne ryzyko |
| 299–300 | Theon bierze Winterfell; Krwawe Gody; mroczny łuk Manderly'ego | Odległe — wplatać dopiero gdy gra tam dojdzie |

## TEMPO A UDZIAŁ (kluczowe)
Gra idzie ~pół dnia/turę. Od 297-10 do:
- **297-11** (kruk) = tygodnie gry → **blisko, dojdziemy zwykłą grą**.
- **298-04** (król) = ~6 mies. gry ≈ setki tur half-day.
- **299** (wojna) = ~1,5 roku gry ≈ 1000+ tur half-day.
Żeby REALNIE dotrzeć do wielkich okien 298/299, trzeba **montażu / skoków czasu**
(gra ma precedens: „skondensować przebieg"). Inaczej wielkie wydarzenia zostaną
latami tur naprzód. Wybór trybu = decyzja gracza (patrz niżej), NIE forsować.
